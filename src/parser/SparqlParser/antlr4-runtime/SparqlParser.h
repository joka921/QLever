...
class SparqlParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleSelectors = 6,
    RuleAlias = 7,
    RuleConstructQuery = 8,
    RuleDescribeQuery = 9,
    RuleAskQuery = 10,
    RuleDatasetClause = 11,
    RuleDefaultGraphClause = 12,
    RuleNamedGraphClause = 13,
    RuleSourceSelector = 14,
    RuleWhereClause = 15,
    RuleSolutionModifier = 16,
    RuleLimitOffsetClauses = 17,
    RuleOrderClause = 18,
    RuleGroupClause = 19,
    RuleHavingClause = 20,
    RuleOrderCondition = 21,
    RuleLimitClause = 22,
    RuleOffsetClause = 23,
    RuleGroupGraphPattern = 24,
    RuleTriplesBlock = 25,
    RuleGraphPatternNotTriples = 26,
    RuleOptionalGraphPattern = 27,
    RuleGraphGraphPattern = 28,
    RuleGroupOrUnionGraphPattern = 29,
    RuleFilter = 30,
    RuleConstraint = 31,
    RuleFunctionCall = 32,
    RuleArgList = 33,
    RuleConstructTemplate = 34,
    RuleConstructTriples = 35,
    RuleTriplesSameSubject = 36,
    RulePropertyListNotEmpty = 37,
    RulePropertyList = 38,
    RuleObjectList = 39,
    RuleObject = 40,
    RuleVerb = 41,
    RuleTriplesNode = 42,
    RuleBlankNodePropertyList = 43,
    RuleCollection = 44,
    RuleGraphNode = 45,
    RuleVarOrTerm = 46,
    RuleVarOrIRIref = 47,
    ...
    RuleGraphTerm = 49,
    RuleExpression = 50,
    RuleConditionalOrExpression = 51,
    RuleConditionalAndExpression = 52,
    RuleValueLogical = 53,
    RuleRelationalExpression = 54,
    RuleNumericExpression = 55,
    RuleAdditiveExpression = 56,
    RuleMultiplicativeExpression = 57,
    RuleUnaryExpression = 58,
    RulePrimaryExpression = 59,
    RuleBrackettedExpression = 60,
    RuleRegexExpression = 61,
    RuleIriRefOrFunction = 62,
    RuleRdfLiteral = 63,
    RuleNumericLiteral = 64,
    RuleNumericLiteralUnsigned = 65,
    RuleNumericLiteralPositive = 66,
    RuleNumericLiteralNegative = 67,
    RuleBooleanLiteral = 68,
    RuleString = 69,
    RuleIriRef = 70,
    RulePrefixedName = 71,
    RuleBlankNode = 72
  ...
  class IriRefOrFunctionContext : public antlr4::ParserRuleContext {
   public:
    IriRefOrFunctionContext(antlr4::ParserRuleContext* parent,
                            size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IriRefContext* iriRef();
    ArgListContext* argList();
