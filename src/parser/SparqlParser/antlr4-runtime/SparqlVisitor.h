...
class SparqlVisitor : public antlr4::tree::AbstractParseTreeVisitor {
 public:
  ...
  virtual antlrcpp::Any visitQueryBody(
      SparqlParser::QueryBodyContext* context) = 0;

  virtual antlrcpp::Any visitPrologue(
      SparqlParser::PrologueContext* context) = 0;

  virtual antlrcpp::Any visitBaseDecl(
      SparqlParser::BaseDeclContext* context) = 0;

  virtual antlrcpp::Any visitPrefixDecl(
      SparqlParser::PrefixDeclContext* context) = 0;

  virtual antlrcpp::Any visitSelectQuery(
      SparqlParser::SelectQueryContext* context) = 0;

  virtual antlrcpp::Any visitSelectors(
      SparqlParser::SelectorsContext* context) = 0;

  virtual antlrcpp::Any visitAlias(SparqlParser::AliasContext* context) = 0;

  virtual antlrcpp::Any visitConstructQuery(
      SparqlParser::ConstructQueryContext* context) = 0;

  virtual antlrcpp::Any visitDescribeQuery(
      SparqlParser::DescribeQueryContext* context) = 0;

  virtual antlrcpp::Any visitAskQuery(
      SparqlParser::AskQueryContext* context) = 0;

  virtual antlrcpp::Any visitDatasetClause(
      SparqlParser::DatasetClauseContext* context) = 0;

  virtual antlrcpp::Any visitDefaultGraphClause(
      SparqlParser::DefaultGraphClauseContext* context) = 0;

  virtual antlrcpp::Any visitNamedGraphClause(
      SparqlParser::NamedGraphClauseContext* context) = 0;

  virtual antlrcpp::Any visitSourceSelector(
      SparqlParser::SourceSelectorContext* context) = 0;

  virtual antlrcpp::Any visitWhereClause(
      SparqlParser::WhereClauseContext* context) = 0;

  virtual antlrcpp::Any visitSolutionModifier(
      SparqlParser::SolutionModifierContext* context) = 0;

  virtual antlrcpp::Any visitLimitOffsetClauses(
      SparqlParser::LimitOffsetClausesContext* context) = 0;

  virtual antlrcpp::Any visitOrderClause(
      SparqlParser::OrderClauseContext* context) = 0;

  virtual antlrcpp::Any visitGroupClause(
      SparqlParser::GroupClauseContext* context) = 0;

  virtual antlrcpp::Any visitHavingClause(
      SparqlParser::HavingClauseContext* context) = 0;

  virtual antlrcpp::Any visitOrderCondition(
      SparqlParser::OrderConditionContext* context) = 0;

  virtual antlrcpp::Any visitLimitClause(
      SparqlParser::LimitClauseContext* context) = 0;
  ...
  virtual antlrcpp::Any visitGraphPatternNotTriples(
      SparqlParser::GraphPatternNotTriplesContext* context) = 0;

  virtual antlrcpp::Any visitOptionalGraphPattern(
      SparqlParser::OptionalGraphPatternContext* context) = 0;

  virtual antlrcpp::Any visitGraphGraphPattern(
      SparqlParser::GraphGraphPatternContext* context) = 0;

  virtual antlrcpp::Any visitGroupOrUnionGraphPattern(
      SparqlParser::GroupOrUnionGraphPatternContext* context) = 0;

  virtual antlrcpp::Any visitFilter(SparqlParser::FilterContext* context) = 0;

  virtual antlrcpp::Any visitConstraint(
      SparqlParser::ConstraintContext* context) = 0;

  virtual antlrcpp::Any visitFunctionCall(
      SparqlParser::FunctionCallContext* context) = 0;
  ...
  virtual antlrcpp::Any visitBlankNodePropertyList(
      SparqlParser::BlankNodePropertyListContext* context) = 0;

  virtual antlrcpp::Any visitCollection(
      SparqlParser::CollectionContext* context) = 0;

  virtual antlrcpp::Any visitGraphNode(
      SparqlParser::GraphNodeContext* context) = 0;

  virtual antlrcpp::Any visitVarOrTerm(
      SparqlParser::VarOrTermContext* context) = 0;

  virtual antlrcpp::Any visitVarOrIRIref(
      SparqlParser::VarOrIRIrefContext* context) = 0;

  virtual antlrcpp::Any visitVar(SparqlParser::VarContext* context) = 0;

  virtual antlrcpp::Any visitGraphTerm(
      SparqlParser::GraphTermContext* context) = 0;

  virtual antlrcpp::Any visitExpression(
      SparqlParser::ExpressionContext* context) = 0;

  virtual antlrcpp::Any visitConditionalOrExpression(
      SparqlParser::ConditionalOrExpressionContext* context) = 0;

  virtual antlrcpp::Any visitConditionalAndExpression(
      SparqlParser::ConditionalAndExpressionContext* context) = 0;

  virtual antlrcpp::Any visitValueLogical(
      SparqlParser::ValueLogicalContext* context) = 0;

  virtual antlrcpp::Any visitRelationalExpression(
      SparqlParser::RelationalExpressionContext* context) = 0;

  virtual antlrcpp::Any visitNumericExpression(
      SparqlParser::NumericExpressionContext* context) = 0;

  virtual antlrcpp::Any visitAdditiveExpression(
      SparqlParser::AdditiveExpressionContext* context) = 0;

  virtual antlrcpp::Any visitMultiplicativeExpression(
      SparqlParser::MultiplicativeExpressionContext* context) = 0;

  virtual antlrcpp::Any visitUnaryExpression(
      SparqlParser::UnaryExpressionContext* context) = 0;

  virtual antlrcpp::Any visitPrimaryExpression(
      SparqlParser::PrimaryExpressionContext* context) = 0;

  virtual antlrcpp::Any visitBrackettedExpression(
      SparqlParser::BrackettedExpressionContext* context) = 0;
  ...
  virtual antlrcpp::Any visitNumericLiteral(
      SparqlParser::NumericLiteralContext* context) = 0;

  virtual antlrcpp::Any visitNumericLiteralUnsigned(
      SparqlParser::NumericLiteralUnsignedContext* context) = 0;

  virtual antlrcpp::Any visitNumericLiteralPositive(
      SparqlParser::NumericLiteralPositiveContext* context) = 0;

  virtual antlrcpp::Any visitNumericLiteralNegative(
      SparqlParser::NumericLiteralNegativeContext* context) = 0;

  virtual antlrcpp::Any visitBooleanLiteral(
      SparqlParser::BooleanLiteralContext* context) = 0;
  ...
  virtual antlrcpp::Any visitPrefixedName(
      SparqlParser::PrefixedNameContext* context) = 0;

  virtual antlrcpp::Any visitBlankNode(
      SparqlParser::BlankNodeContext* context) = 0;
};
