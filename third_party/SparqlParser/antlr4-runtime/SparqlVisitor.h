...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitQueryBody(SparqlParser::QueryBodyContext *context) = 0;
    ...
    virtual antlrcpp::Any visitSelectors(SparqlParser::SelectorsContext *context) = 0;
